...
export const BookCard = ({ book, onAddToCart, onClick }: BookCardProps) => {
  ...
  return (
    <div 
      onClick={onClick}
      className="group relative bg-card dark:bg-card rounded-xl overflow-hidden shadow-[var(--shadow-card)] hover:shadow-[var(--shadow-hover)] transition-all duration-300 hover:-translate-y-1 border border-border cursor-pointer">
